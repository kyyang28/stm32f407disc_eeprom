...
//	suspendRxSignal();
	...
	/* Read flash */
//	printf("g_materConfig.version: %u, %s, %d\r\n", g_materConfig.version, __FUNCTION__, __LINE__);			// g_materConfig.version: 0
//	printf("g_materConfig.size: %u, %s, %d\r\n", g_materConfig.size, __FUNCTION__, __LINE__);				// g_materConfig.size: 0
//	printf("g_materConfig.magic_be: 0x%x, %s, %d\r\n", g_materConfig.magic_be, __FUNCTION__, __LINE__);		// g_materConfig.magic_be: 0
//	printf("g_materConfig.magic_ef: 0x%x, %s, %d\r\n", g_materConfig.magic_ef, __FUNCTION__, __LINE__);		// g_materConfig.magic_ef: 0
//	printf("g_materConfig.chk: %u, %s, %d\r\n", g_materConfig.chk, __FUNCTION__, __LINE__);					// g_materConfig.chk: 0
//	printf("g_materConfig.motorConfig.minthrottle: %u\r\n", g_materConfig.motorConfig.minthrottle);			// g_materConfig.motorConfig.minthrottle = 0
//	printf("g_materConfig.motorConfig.maxthrottle: %u\r\n", g_materConfig.motorConfig.maxthrottle);			// g_materConfig.motorConfig.maxthrottle = 0
//	printf("g_materConfig.motorConfig.mincommand: %u\r\n", g_materConfig.motorConfig.mincommand);			// g_materConfig.motorConfig.mincommand = 0
//	printf("g_materConfig.motorConfig.motorPwmProtocol: %u\r\n", g_materConfig.motorConfig.motorPwmProtocol);	// g_materConfig.motorConfig.motorPwmProtocol = 0
//	printf("g_materConfig.motorConfig.motorPwmRate: %u\r\n\r\n", g_materConfig.motorConfig.motorPwmRate);	// g_materConfig.motorConfig.motorPwmRate = 0
	
	/* copy contents from CONFIG_START_FLASH_ADDRESS(0x08080000) to g_materConfig */
	memcpy(&g_materConfig, (char *)CONFIG_START_FLASH_ADDRESS, sizeof(master_t));
	
//	printf("g_materConfig.version: %u, %s, %d\r\n", g_materConfig.version, __FUNCTION__, __LINE__);			// g_materConfig.version: 157
//	printf("g_materConfig.size: %u, %s, %d\r\n", g_materConfig.size, __FUNCTION__, __LINE__);				// g_materConfig.size: 876
//	printf("g_materConfig.magic_be: 0x%x, %s, %d\r\n", g_materConfig.magic_be, __FUNCTION__, __LINE__);		// g_materConfig.magic_be: 0xbe
//	printf("g_materConfig.magic_ef: 0x%x, %s, %d\r\n", g_materConfig.magic_ef, __FUNCTION__, __LINE__);		// g_materConfig.magic_ef: 0xef
//	printf("g_materConfig.chk: %u, %s, %d\r\n", g_materConfig.chk, __FUNCTION__, __LINE__);					// g_materConfig.chk: 244
//	printf("g_materConfig.motorConfig.minthrottle: %u\r\n", g_materConfig.motorConfig.minthrottle);			// g_materConfig.motorConfig.minthrottle = 1070
//	printf("g_materConfig.motorConfig.maxthrottle: %u\r\n", g_materConfig.motorConfig.maxthrottle);			// g_materConfig.motorConfig.minthrottle = 2000
//	printf("g_materConfig.motorConfig.mincommand: %u\r\n", g_materConfig.motorConfig.mincommand);			// g_materConfig.motorConfig.minthrottle = 1000
//	printf("g_materConfig.motorConfig.motorPwmProtocol: %u\r\n", g_materConfig.motorConfig.motorPwmProtocol);	// g_materConfig.motorConfig.minthrottle = 0
//	printf("g_materConfig.motorConfig.motorPwmRate: %u\r\n\r\n", g_materConfig.motorConfig.motorPwmRate);	// g_materConfig.motorConfig.minthrottle = 480
